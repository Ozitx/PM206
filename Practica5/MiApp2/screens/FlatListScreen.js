...
//Zona2: main - hogar de la aplicación
export default function FlatSectionListScreen() {
  ...
  const [secciones, setSecciones] = useState([
    ...
    {
      tituloCategoria: 'Frituras',
      data: ['Megacrunch', 'Doritos', 'Ruffles']
    },
    {
      tituloCategoria: 'Dulces',
      data: ['PelonPelorico', 'Skittles', 'Winnies'],
    },
    {
      tituloCategoria: 'Pan',
      data: ['Vuala', 'Doraditas', 'Cuernitos']
    },
  ]);
